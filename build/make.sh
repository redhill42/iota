...
# This script builds various binary artifacts from a checkout of the Iota
# source code.
#
# Requirements:
# - The current directory should be a checkout of the Iota source code.
#   Whatever version is checked out will be built.
# - The VERSION file, at the root of the repository, should exist, and
#   will be used as Iota binary version and package version.
# - The hash of the git commit will also be included in the Iota binary,
...
#   of the Iota repository.
#   the makefile will do a "docker build -t iota . and then
